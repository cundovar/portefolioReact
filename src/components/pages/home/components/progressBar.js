  ...
  return (
    <>
      ...
      <div className="mt-10  flex justify-center items-center space-x-10">
        <CustomBoutonn text="Languages" onclick={handleButtonLanguage} />
        <CustomBoutonn text="Frameworks" onclick={handleButtonFramework} />
        <CustomBoutonn text="Divers" onclick={handleButtonDivers} />
      </div>
