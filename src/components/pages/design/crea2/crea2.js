        ...
        <section className="bg-stone-100 max-sm:pb-10 p-10  w-full  max-sm:w-full  flex items-center space-x-5  justify-center mb-96 max-sm:flex-col">
          ...
          <div className="right w-1/2  max-sm:w-full   flex flex-col space-y-10 p-10  justify-center">
            ...
            <div className="title w-full ">
              <div>
                <h2 className="text-orange-500 lg:text-xl max-sm:text-center ">SNEAKER COMPAGNY</h2>
              </div>
              <div className="mt-2">
                <h1 className="2xl:text-7xl lg:text-5xl max-sm:text-4xl max-sm:text-stone-900  w-full">Edition Limité</h1>
                <h1 className="2xl:text-7xl lg:text-5xl max-sm:text-4xl max-sm:text-stone-900 ">Sneakers</h1>
              </div>
            </div>
            <div >
                <p className="text 2xl:w-4/6 text-justify text-stone-500" >
                Vous trouvez ici une page produit avec selction d'iamges et un carouselle en modal en cliquant sur l'image principale. Une petit compteur pour le panier. 
                </p>
                <p className="text 2xl:w-4/6 text-justify text-stone-500">
                    Cette page est codé 100% en Tailwind, responsive tablette, smartphone et ecran.
                </p>
            </div>
            ...
            <div className="panier flex  space-x-1 w-2/3 max-sm:w-full justify-center items-center max-sm:flex-col max-sm:space-y-3 max-sm:pt-10 ">
              <div className="cursor w-1/3 flex max-sm:w-full " >
                <div className="  w-1/3 border rounded-xl bg-stone-300  flex items-center justify-center p-4 text-3xl max-sm:p-2 text-orange-600   " onClick={incrementCount} >+</div>
                <div className="w-1/3 border  rounded-xl bg-stone-300 flex items-center justify-center p-4 text-3xl max-sm:p-2 "> {count} </div>
                <div className="w-1/3 border rounded-xl bg-stone-300  flex items-center justify-center p-4 text-3xl max-sm:p-2  text-orange-600  " onClick={decrementCount} >-</div>
              </div>
              <button className="flex items-center justify-center rounded-2xl w-2/3 max-sm:w-full bg-orange-500 space-x-5 p-5 ">
                <div >   <FontAwesomeIcon className="text-xl" icon={faCartShopping} /></div>
